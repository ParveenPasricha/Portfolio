    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-24">
        ...
        <div className="text-center">
          ...
          <img
            className="w-60 h-60 rounded-full my-20 cursor-pointer hover:opacity-45 ease-in-out"
        ...
        <div className="text-center">
          ...
          <img
            className="w-60 h-60 rounded-full my-20 cursor-pointer hover:opacity-45"
